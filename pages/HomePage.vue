    ...
    <Switcher limit="2" threshold="70rem" space="6rem">
      ...
      <div class="banner-item banner-hero">
        ...
        <div class="banner-hero--actions">
          <a class="btn btn-main" href="/getting-started">Get Started</a>
    ...
    <div class="components-groups">
      <Switcher limit="3" threshold="30rem" space="2rem">
        ...
        <div class="components--group">
          <h3>Switch</h3>
          <div>
            <input type="checkbox" class="switch" id="components-switch-1">
            <label for="components-switch-1">Switch</label>
          </div>
          <div>
            <input type="checkbox" class="switch switch-round" id="components-switch-2">
            <label for="components-switch-2">Switch</label>
          </div>
        </div>
